...
p=argparse.ArgumentParser(description='Query Aster V1 order')
...
try:
    ...
    code,body=c.signed_request('GET','/fapi/v1/order',params)
    print(json.dumps({'query_order':format_exchange_response(code,body)},ensure_ascii=False))
