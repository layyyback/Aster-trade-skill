#!/usr/bin/env python3
"""Get index price references (source exchanges and weights)."""
...
def main() -> int:
    try:
        p = argparse.ArgumentParser(description="Get index price references")
        ...
        return output_json(c.get("/fapi/v3/indexPriceReferences", params))
