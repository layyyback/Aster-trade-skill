...
def main() -> int:
    try:
        p = argparse.ArgumentParser(description="Get index price klines")
        ...
        params = {"pair": args.pair, "interval": args.interval, "limit": args.limit}
        if args.start_time:
        ...
        return output_json(c.get("/fapi/v3/indexPriceKlines", params))
